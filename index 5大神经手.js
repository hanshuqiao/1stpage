  ...
  init: function (start) {
    if (start != 0){
      ...
      if (i !== -1) {
        ...
        S.UI.simulate('|#countdown 3||祝|Diana|生日快乐|祝姐姐|天天快乐|不负去岁|你最珍贵！|不管几岁|快乐万岁！|感恩相遇|陪伴永远|#icon heart|#icon heart-empty|#icon heart');
      }
...
S.Drawing = (function () {
  ...
  return {
    ...
    drawCircle: function (p, c) {
      ...
      context.beginPath();
      context.arc(p.x, p.y, p.z * ratio, 0, 2 * Math.PI, true);
      context.closePath();
      context.fill();
    },
  ...
  function performAction(value, start) {
    ...
    timedAction(function (index) {
      ...
      switch (action) {
        ...
        case 'icon':
          S.ShapeBuilder.imageFile(value + '.png', function (obj) {
  ...
  return {
    imageFile: function (url, callback) {
      ...
      image.onload = function () {
        ...
        var width = Math.min(a.h, a.w) * 0.8;
        shapeContext.drawImage(this, 0, 0, width, width);
